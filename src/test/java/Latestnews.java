import Pageobject.LatestnewsPO;
...
public class Latestnews extends base {
    ...
    LatestnewsPO ln = new LatestnewsPO(driver);
    ...
    public void verifyassertions() throws InterruptedException {
        ...
        ln = new LatestnewsPO(driver);
        Actions actions = new Actions(driver);
        Thread.sleep(3000);
        WebElement dropdown = ln.getdropdown();
        Thread.sleep(3000);
        actions.moveToElement(dropdown).perform();
        Thread.sleep(5000);
        long startTime = System.currentTimeMillis();
        Thread.sleep(5000);
        driver.get("https://dev.weisetechdev.com/adventuregamers/latest-news/");
        ...
        Assert.assertEquals(driver.getTitle(), "Latest News – Adventure Gamers");
        Thread.sleep(2000);

        Assert.assertTrue(driver.getCurrentUrl().contains("/latest-news/"));
        Thread.sleep(2000);
    ...
    public void tablinks() throws InterruptedException {
        List<WebElement> tabs = ln.getarticelcategory();
    ...
    public void Allimages() throws InterruptedException {
        Thread.sleep(5000);
        List<WebElement> img = ln.getallimag();
        log.info(img.size());
    ...
    @Test(priority = 4)
    public void Allnews() throws InterruptedException {
        List<WebElement> games = ln.getallnews();
