...
public class Gamedatabasepage extends base {
    public WebDriver driver;
    ExtentReports extent = ExtentReporterNG.getReportObject();
    ExtentTest test;
    public static Logger log = LogManager.getLogger(base.class.getName());
    GamedatabasePO gd = new GamedatabasePO(driver);
    ...
    public void verifyassertions() throws InterruptedException {
        ...
        gd = new GamedatabasePO(driver);
        Actions actions = new Actions(driver);
        Thread.sleep(3000);
        WebElement dropdown = gd.getdropdown();
        Thread.sleep(3000);
        actions.moveToElement(dropdown).perform();
        Thread.sleep(5000);
        long startTime = System.currentTimeMillis();
        Thread.sleep(5000);
        driver.get("https://dev.weisetechdev.com/adventuregamers/adventure/all/");
        ...
        Assert.assertEquals(driver.getTitle(), "Games Database – Adventure Gamers");
        Thread.sleep(2000);

        Assert.assertTrue(driver.getCurrentUrl().contains("/all/"));
        Thread.sleep(2000);
    ...
    public void Allgameslink() throws InterruptedException {
        List<WebElement> games = gd.getgamessorted();
