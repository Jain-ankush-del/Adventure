...
public class Interviewpage extends base {
    ...
    InterviewPO ip = new InterviewPO(driver);
    ...
    public void verifyassertions() throws InterruptedException {
        ...
        ip = new InterviewPO(driver);
        Actions actions = new Actions(driver);
        Thread.sleep(3000);
        WebElement dropdown = ip.getdropdown();
        Thread.sleep(3000);
        actions.moveToElement(dropdown).perform();
        Thread.sleep(5000);
        long startTime = System.currentTimeMillis();
        Thread.sleep(5000);
       // ip.getinterviewmenu().click();
        driver.get("https://dev.weisetechdev.com/adventuregamers/article-type/interview/");
        ...
        Assert.assertEquals(driver.getTitle(), "Interview – Adventure Gamers");
        Thread.sleep(2000);

        Assert.assertTrue(driver.getCurrentUrl().contains("/article-type/interview/"));
        Thread.sleep(2000);
    ...
    public void tablinks() throws InterruptedException {
        List<WebElement> tabs = ip.getarticelcategory();
    ...
    public void Allimages() throws InterruptedException {
        Thread.sleep(5000);
        List<WebElement> img = ip.getallimag();
        log.info(img.size());
    ...
    public void Allgameslink() throws InterruptedException {
        List<WebElement> games = ip.getallgames();
