...
public class pctest extends base {
    ...
    public void verifyAllLinksOnDealsPage() throws InterruptedException {
        ...
        Thread.sleep(3000);
        Thread.sleep(3000);
       List<WebElement> links = pc.getAllLinks();
        ...
        System.out.println("============================================================");
        System.out.println("---- All Links on PC Page ----");
        System.out.println("============================================================");
    ...
    public void verifyassertions() throws InterruptedException {
        ...
        Assert.assertEquals(driver.getTitle(), "Latest adventure games coverage for PC | Adventure Gamers");
        Thread.sleep(2000);

        Assert.assertTrue(driver.getCurrentUrl().contains("categories/pc"));
        Thread.sleep(2000);
